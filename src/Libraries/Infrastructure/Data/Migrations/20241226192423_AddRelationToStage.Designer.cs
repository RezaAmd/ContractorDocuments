...
namespace ContractorDocuments.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241226192423_AddRelationToStage")]
    partial class AddRelationToStage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ContractorDocuments.Domain.Entities.Projects.ProjectStageEquipmentEntity", b =>
                {
                    ...
                    b.HasOne("ContractorDocuments.Domain.Entities.Projects.ProjectStageExpenseEntity", "Expense")
                        .WithMany()
